...
Além disso, o GearHub gerencia documentos relacionados aos veículos, como licenciamento, comprovantes de pagamento, seguros e outros. Para cada documento são registrados o arquivo em si, o ano de referência, a data de upload, a data de pagamento, o tipo do documento e seu status. Cada documento está sempre vinculado a apenas um veículo.
